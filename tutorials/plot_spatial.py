...
# let us now compute the width of each spatial bin
...
# let us now calculate the spatial information for the x-dimension only
data = spike_x
...
# now compute the 2D spatial information for spikes

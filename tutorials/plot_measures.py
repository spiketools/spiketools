...
# Here, spike time refers to a representation of spiking activity based on listing the times at which spikes occur and spike rate measures how fast an individual neuron is firing.
...
# Then, we can compute the inter-spike intervals, measures of the time intervals between successive spikes, of that vector of spike times.
#
...
# First, we convert a vector of spike times in millisecond to a binary spike train, which is a representation of spiking activity in which spikes are. 
#
